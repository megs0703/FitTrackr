...
\title{\textbf{FitTrackr} \\ Health \& Fitness Progress Tracker \\ \large Web Application Development Report}
...
\begin{itemize}
    ...
    \item \textbf{mysql2}: MySQL database driver
...
\subsection{Database}
\begin{itemize}
    \item \textbf{MySQL 5.7+}: Relational database management system
\end{itemize}
...
\begin{itemize}
    \item \textbf{Backend}: Deployed on Render.com
    \item \textbf{Frontend}: Deployed on Vercel.com
    \item \textbf{Database}: MySQL on Railway or PlanetScale
\end{itemize}
